...
8c. **不要在讀者看得見的任何文字裡描述材料的來源形式。** 正文、標題與註釋一律適用——註釋也是讀者讀的。 「補充講道把這一點說得更具體」「原聲印證了這個著重」「母本另有說明」這類句子，是在向讀者聲稱某項內容出自某個來源——而材料本身並不包含這種歸屬陳述，它會被判為假造來源。

   材料的分層是編輯部的內部結構，不是讀者需要的資訊。要交代不同來源的著重差異，直接寫出那個差異的內容（「當時普遍的期待是⋯⋯」），不要寫它來自哪一層。真正需要點名歸屬的只有三種情況：首次歸屬給教授、來源之間有真張力時，以及引述教授原話時（見 8e）。

   「材料」「來源」「母本」「補充講道」這些詞本身就是編輯部的說法，讀者不知道它們指甚麼。註釋寫「材料中的讀音轉寫為 fron-eh'-o」，讀者讀到的是「有一份我看不到的東西」；直接寫「讀音 fron-eh'-o」就好。
