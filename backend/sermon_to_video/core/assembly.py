...
def assemble_scene(scene_data: dict, output_path: str, font_path: str = None) -> str:
    """
    ...
    if visual_source_override:
        ...
        if actual_duration < duration_sec:
            ...
            if hasattr(video_clip, 'with_speed_scaled'):
                ...
                video_clip = video_clip.fl_time(lambda t: t * speed_factor, apply_to='mask').with_duration(duration_sec)
