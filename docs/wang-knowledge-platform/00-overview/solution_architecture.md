...
| 这一段 | 由谁承担 | 它是什么 | 少了它会怎样 |
| --- | --- | --- | --- |
| **观点** | 观点记录<br/>（`CanonicalViewpoint`） | **「他的观点」本身**。同一个观点在五篇讲道里讲过，就是 1 个观点记录、5 条主张 | 只能说「这 12 条主张彼此相关」，不能说「教授对因信成义的看法是」 |
| **论证** | 主张记录（`Claim`）<br/>论证路线（`ArgumentRoute`） | **主张**是他在某一篇里提出的一个判断，连同他引的经文和从经文推到结论的步骤。**论证路线**是同一个观点在不同讲道里各自的论证方式 | 只剩结论，读者不知道他凭什么这样讲 |
| **可查证、可回溯** | 来源记录 | 教授原话的逐字片段、它在录音里的时间位置、以及这份来源的内容哈希 | 谁也无法核对这是不是他说的 |
...
「同一样东西在很多地方出现过，得有个地方说清楚哪个是准的、以及凭什么」——这在业界叫 **master data management（主数据管理，MDM）**。教授的观点正是这样的东西，所以这一层不是自创结构，是一个成熟模式。

**决策**：观点身份分三层记录——来源里的主张（`Claim`）、把主张挂到观点上的连接记录、观点本身（`CanonicalViewpoint`）。**来源主张全部原样保留，不改写。**
