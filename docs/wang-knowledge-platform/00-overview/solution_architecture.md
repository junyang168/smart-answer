...
**为什么不用**：靠人拦最贵，也最不可靠——编造出来的话往往比原话还通顺，审的人没有理由起疑。而且它与 D3 冲突：把一件本可机械判定的事塞进了人工队列。
