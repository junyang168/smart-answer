...
| [4. 关键决策](#4-关键决策) | D1–D6，每条含其他解决方案与不用它的理由 |
...
**为什么不用**：两者形态不同。讲道是口语——重复、跳转、离题、现场问答混在一起，论证结构要从话里重建；母本来自教授备课时写下的笔记，表述本来就是组织过的。**注意区别不在可信度，两者都经同工校对。**
