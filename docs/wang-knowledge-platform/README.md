...
本目录记录「王守仁教授圣经讲论文库」作为独立知识平台的使命、产品设计、技术架构、语料普查方法和出版蓝图。
...
| [查经准备：从 Carson 与教授讲道到逐字稿和 PPT](./60-reference-commentary/bible_study_prep_solution_v1.md) | 讨论纪要怎样进逐字稿、逐字稿怎样追到来源、PPT 只放重点（草案，待批准） |
