...
CanonicalViewpoint Registry 的 feature introduction 位于 [#200](https://github.com/junyang168/smart-answer/issues/200)。2026-08-23 的 production batch resolution 简化决策由 [#204](https://github.com/junyang168/smart-answer/issues/204) 追踪；规范流程为 Opus 5/high proposal、确定性 validation、GPT-5.6 sol/high independent review、最多一次 finding-only reconsideration 与原子 Registry ChangeSet。旧 recall/signature/promotion artifacts 保留为历史诊断，不再是每批必经流程。
