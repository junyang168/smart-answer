...
經過審核的材料將形成一個可查證、可修訂的思想脈絡與論證知識庫。文章不是知識圖自動排版的結果，而是編輯按照使用者批准的出版體例和逐篇編排計畫，選擇、組織知識材料後完成的新著作；同一知識基礎還要驅動按聖經次序組織的釋經文章、跨講道的專題論述、有來源依據的智能問答、經文與原文搜索、思想發展比較、課程、王教授釋經方法研究，以及對其學術思想整體結構與發展過程的系統整理。
...
> 本計畫以王守仁教授兩百多篇講道、錄音、逐字稿和筆記為原始依據，保存教授實際表達的主張、經文依據和論證過程，逐步辨識其在不同經文與主題中反覆出現的思想脈絡和釋經方法。在清楚區分教授明說、直接推論、編輯歸納和待研究問題的前提下，建立一個可查證、可審核、可持續修訂的知識基礎，並據此編寫聖經釋經文章、專題論述和有來源依據的查考問答。
