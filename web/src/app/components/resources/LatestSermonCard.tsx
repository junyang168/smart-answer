  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
      ...
      <p className="text-sm text-gray-500 mt-1 mb-3">
        <b>講道日期:</b> {sermon.date} | <b>認領人:</b> {sermon.assigned_to_name} | <b>校對完成:</b> {sermon.published_date || ''}
      </p>
      <p className="text-gray-700 mb-4">{sermon.summary}</p>
      <div className="flex items-center gap-4 text-sm font-semibold">
        <a href={'/resources/sermons/' + sermon.id} target="_blank" rel="noopener noreferrer" className="text-[#8B4513] hover:underline">
          ▶️ 觀看
        </a>
      </div>
    </div>
